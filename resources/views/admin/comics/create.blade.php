...
<div class="container mb-5 py-4">
    ...
    <form action="{{route('comics.store')}}" method="post" class="card p-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="title" id="title" class="form-control" aria-describedby="titleHlper" value="{{ old('title') }}">
            <small id=" titleHlper" class="text-muted">Add comics title here</small>
        </div>
        <div class="mb-3">
            <label for="image" class="form-label">Product Image</label>
            <input type="text" name="image" id="image" class="form-control" aria-describedby="imageHlper" value="{{ old('image') }}">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="00.1" name="price" id="price" class="form-control" aria-describedby="priceHlper" value="{{ old('price') }}">
            <small id="priceHlper" class="text-muted">Add the product price here</small>
        </div>
        <div class="mb-3">
            <label for="series" class="form-label">Series</label>
            <input type="text" name="series" id="series" class="form-control" aria-describedby="seriesHlper" value="{{ old('series') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="sale_date" id="sale_date" class="form-control" aria-describedby="sale_dateHlper" value="{{ old('sale_date') }}">
            <small id="sale_dateHlper" class="text-muted">Add the product sale_date here</small>
        </div>
        <div class="mb-3">
            <label for="type" class="form-label">Product type</label>
            <input type="text" name="type" id="type" class="form-control" aria-describedby="typeHlper" value="{{ old('type') }}">
